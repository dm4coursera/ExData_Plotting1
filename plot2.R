plot2 <- function() {
  # This function creates "plot2.png" for the Peer Reviewed project 1 assignment
  ...
  # Create a PNG linechart that matches the assignment instructions
  plot(energy$timestamp, energy$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab="")
  dev.off()
}